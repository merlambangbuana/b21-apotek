...
<html lang="en">
  ...
  .file {
	...
	<h3> Menambah Data Obat </h3>	
   <?=form_open_multipart('Cadmin/proses_input')?>
    <div class="form-group">
      <label for="id_obat">Id Obat :</label>
      <input type="text" name="id_obat" class="form-control" placeholder="Masukan Id Obat" id="id_obat" required>
    </div>
    <div class="form-group">
      <label for="nama_obat">Nama Obat :</label>
      <input type="text" name="nama_obat" class="form-control" placeholder="Masukan Nama Obat" id="nama_obat" required>
    </div>
	<div class="form-group">
    <label for="jenis_obat"> Jenis Obat</label>
        <select class="form-control" name="jenis_obat">
                <option  value="">---Jenis Obat---</option>                    
            <?php foreach($get_jenis_obat as $row) { ?>
    ...
    <div class="form-group">
      ...
      <input type="number" name="harga" class="form-control" placeholder="Masukan Harga Obat" id="harga" required>
    </div>
    <div class="form-group">
      <label for="stock">Stock :</label>
      <input type="number" name="stock" class="form-control" placeholder="Masukan Stock Obat" id="stock" required>
    </div>
	<div class="form-group">
      <label for="deskripsi_obat">Deskripsi Obat :</label>
      <input type="text" name="deskripsi_obat" class="form-control" placeholder="Masukan Nama Obat" id="deskripsi_obat" required>
    </div>
    <div class="form-group">
